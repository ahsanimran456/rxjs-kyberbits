...
export const ContainerScroll = ({ titleComponent, children }) => {
  ...
  // Ensure the output matches the input length for scale transformation
  const scaleDimensions = () => {
    const [min, max] = isMobile ? [0.7, 0.9] : [1.05, 1];
    return [min, (min + max) / 2, max]; // Generate 3 values for the scale
  };
  ...
  return (
    <div className="flex justify-center relative p-2 md:px-20  pb-0" ref={containerRef}>
      <div
